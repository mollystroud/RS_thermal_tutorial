...
```{r libraries}
pacman::p_load(rstac, gdalcubes, stars, dplyr, sf)
...
intuitive name, and rescale the values to degrees Celsius since the raw
thermal band values are not in degrees.
